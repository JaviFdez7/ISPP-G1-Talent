...
import { handleNetworkError } from '../TokenExpired'
import { useNavigate } from 'react-router-dom'

const DeleteHistorySearchButton = ({ history, toggleText = false, setErrorMessage }) => {
	...
	return (
		<>
			<button
				...
				{toggleText && <span className='ml-2'>Delete</span>}
			</button>
			...
			<Modal
				...
				<h2 style={{ marginBottom: '3%' }}>
					Are you sure you want to delete this history search entry?
				</h2>
				<div>
					<button
...
export default DeleteHistorySearchButton
