		...
		<div
				...
				<div className='flex flex-col mt-10 w-fit'>
					...
					<div className='flex flex-col w-full profile-info-text'>
						...
						<div className='text-white mt-8'>
							<FontAwesomeIcon icon={faMapMarkerAlt} style={{ color: textColor2 }} />
							{candidate.residence}{' '}
			...
			<div className='flex flex-col w-8/12 self-center'>
				...
				<div className='w-full'>
					{Input('Github username', 'martinnez123', false, true)}{' '}
			...
			<hr className='w-5/12 self-center'></hr>
			<div className='w-9/12 self-center' style={{ marginBottom: '3rem', marginTop: '3rem' }}>
					...
					<DataTable
						...
						contentArray={
							experience
								? experience.map(
										(exp) =>
											`Company Name: ${exp.companyName} || Professional Area: ${exp.professionalArea}`
									)
								: []
						}
						editable={true}
