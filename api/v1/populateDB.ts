...
export async function populate() {
  ...
  const subscription_data = JSON.parse(fs.readFileSync('./populate_data/subcription_data.json','utf-8'))
  ...
  const team_creator_data = JSON.parse(fs.readFileSync('./populate_data/team_creator_data.json', 'utf8'));
  const team_creator_history_data = JSON.parse(fs.readFileSync('./populate_data/team_creator_history_data.json', 'utf8'));
  const notification_data = JSON.parse(fs.readFileSync('./populate_data/notification_data.json', 'utf8'));
